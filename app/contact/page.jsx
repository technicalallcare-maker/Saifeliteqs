          ...
          <div className="cnt-g">
            ...
            <div className="rv rl">
              ...
              <div className="cnt-row">
                ...
                <div><div className="cnt-lbl">WhatsApp</div><div className="cnt-val"><a href={WA_LINK} target="_blank" rel="noreferrer" style={{color:'inherit',textDecoration:'none'}}>+971 56 465 5043</a></div></div>
              </div>
              <div className="cnt-row">
